...
MD5("hello!")   → fc3ff98e8c6a0d3087d515c0473f8677  ← 仅多一个 "!"，完全不同！
```
...
用户输入 "123456"
       ↓ MD5
哈希值 e10adc3949ba59abbe56e057f20f883e
       ↓ 存储
数据库保存哈希值
```
...
```
从数据库偷到：e10adc3949ba59abbe56e057f20f883e
       ↓ 查彩虹表
找到匹配 → 密码是 "123456"
       ↓
破解完成！耗时：0.001 秒
...
暴力破解过程（GPU 并行计算）：
[FAIL] MD5("x7k2m" + "000000") → 7a2b3c4d... ≠ a8f5f167...
[FAIL] MD5("x7k2m" + "000001") → 8b3c4d5e... ≠ a8f5f167...
[FAIL] MD5("x7k2m" + "000002") → 9c4d5e6f... ≠ a8f5f167...
... (每秒尝试数十亿次) ...
[SUCCESS] MD5("x7k2m" + "123456") → a8f5f167... ✓ 密码找到！
